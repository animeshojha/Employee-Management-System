...
function CreateTask() {
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        //   console.log("taks created");
        //   console.table([taskDate, taskDescription, taskTitle , asignTo , category])
                ...
                <div className='w-1/2'>
                    <div>
                        ...
                        <input
                            ...
                            className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' placeholder='MAke UI Design'></input>
                    </div>
                    <div>
